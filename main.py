...
def update_sheet():
    ...
    for date in dates:
        ...
        weight = data.get_days_health_data(data.get_health_data(), 'weight', date) / 1000
        ...
        bone = data.get_days_health_data(data.get_health_data(), 'boneMass', date) / 1000
        muscle = data.get_days_health_data(data.get_health_data(), 'muscleMass', date) / 1000
